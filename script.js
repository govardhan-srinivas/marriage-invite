...
new fullpage("#fullpage", {
  ...
  afterLoad: function (origin, destination) {
    if (window.WeddingBG) window.WeddingBG.resume();
  ...
  onLeave: function (origin) {
    if (window.WeddingBG) window.WeddingBG.pause();
...
// wheel/scroll never count as a browser "user gesture", so autoplay-with-sound
// silently fails until a real click/tap/keypress happens — spell it out here.
